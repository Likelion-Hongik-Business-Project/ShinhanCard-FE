      ...
      <details className="group flex flex-col">
        <summary className="flex items-center h-20 w-full px-10 cursor-pointer">
          ...
          <div className="flex flex-col gap-2">
            <span className="text-body2 group-open:text-body2-b text-gray-80">
              {inquiry.title}
            </span>
          ...
          <Arrow className="w-[14px] h-[8px] ml-auto group-open:rotate-180 group-open:text-main text-gray-30" />
        </summary>
