  ...
  inquiries: [
    {
      ...
      files: [],
      can_edit: false, // 현재 유저가 작성자가 아님
      can_answer: true, // 담당자임
      can_notify: false,
      is_scrapped: false,
    ...
    },
    {
      ...
      content: "현재 컴포넌트 라이브러리의 토큰 구조를 전사 공통으로 가져가도 되는지, 아니면 팀 단위 커스터마이징을 허용하는지 정책이 궁금합니다.\n\n특히 다음 사항들에 대해 알고 싶습니다:\n1. 브랜드 컬러 커스터마이징 가능 여부\n2. 폰트 패밀리 변경 가능 여부\n3. 컴포넌트 크기 조정 가이드라인",
      ...
      comments: [
        {
          ...
          content: "현재 디자인 토큰은 전사 공통으로 관리하고 있습니다. 다만 브랜드 컬러나 특정 컴포넌트의 경우 팀별 커스터마이징이 제한적으로 허용됩니다. 자세한 가이드라인은 디자인 시스템 문서를 참고해주세요.",
    ...
    },
    {
      ...
      content: "GitHub Actions에서 Docker 레이어 캐시를 활용하려면 어떤 설정이 필요한지, 그리고 현재 레이어 캐시가 제대로 동작하는지 확인할 방법이 있을까요.\n\n현재 빌드 시간이 너무 오래 걸려서 캐시 최적화가 필요한 상황입니다.",
      ...
      files: [],
      can_edit: true, // 문의자 본인
      can_answer: false,
      can_notify: false,
      is_scrapped: false,
      confirmed_assignees_count: 1, // 모든 담당자 확인
      confirmed_assignees: [
        {
          user_id: 4,
          name: "이수연",
      ...
      comments: [
        ...
        },
        {
          ...
          content: "추가로, 캐시 효율성을 높이려면 .dockerignore 파일도 잘 관리해야 합니다. 불필요한 파일들이 캐시 키에 영향을 주지 않도록 주의해주세요.",
    ...
    },
    {
      ...
      content: "로그 필드에 개인정보가 포함될 수 있어 필터링 정책을 개편하려고 합니다. 현행 정책 문서가 어디 있는지, 그리고 변경 시 승인 절차가 어떻게 되는지 알고 싶습니다.\n\n특히 개인정보 보호법 관련해서 주의해야 할 사항들이 있다면 알려주세요.",
      inquiry_state: "OPEN",
      ...
      can_edit: true, // 문의자 본인
      can_answer: false,
      can_notify: true, // 문의자는 알림 발송 가능
      is_scrapped: false,
      confirmed_assignees_count: 2, // 모든 담당자 확인했지만
      confirmed_assignees: [
        {
          user_id: 1,
          name: "고다현",
      ...
      comment_count: 0, // 답변은 없음 → 등록 보류 상태
      comments: [],
      follow_ups: [],
    ...
    },
    {
      ...
      content: "Next.js 서비스에 사내 SSO를 붙이려고 하는데, OAuth2 클라이언트 등록 절차와 Redirect URI 정책이 궁금합니다.\n\n개발환경과 운영환경에서 다른 설정이 필요한지도 알고 싶습니다.",
      ...
      can_notify: false,
      is_scrapped: true,
      confirmed_assignees_count: 2, // 모든 담당자 확인
      confirmed_assignees: [
        {
          user_id: 5,
          name: "이승찬",
      ...
      comments: [
        ...
        },
        {
          ...
          content: "Next.js에서는 NextAuth.js를 사용하시는 것을 추천합니다. 사내 OAuth2 프로바이더 설정 예시 코드를 공유드릴게요.",
        ...
        },
        {
          ...
          content: "추가로 개발 완료 후에는 보안 점검을 받아야 합니다. 운영 배포 최소 1주일 전에 신청해주세요.",
      ...
      follow_ups: [
        {
          follow_up_id: 5001,
          content: "혹시 테스트 환경에서 SSL 인증서 관련해서 추가 설정이 필요한가요?",
          ...
          comments: [
            {
              ...
              content: "테스트 환경에서는 자체 서명 인증서도 허용됩니다. 다만 브라우저에서 경고가 나올 수 있으니 참고해주세요.",
    ...
    },
    {
      ...
      content: "한 개의 휴대폰 번호로 계정 1개만 생성 가능하고 CI 기준 최대 3개의 계정을 만들 수 있다고 하셨는데, 예외 케이스가 있는지 알고 싶습니다.\n\n특히 법인 사용자의 경우 어떻게 처리되는지 궁금합니다.",
      inquiry_state: "OPEN",
      ...
      can_edit: true, // 문의자 본인
      can_answer: false,
      can_notify: true, // 알림 발송 가능
      is_scrapped: false,
      confirmed_assignees_count: 0, // 아직 확인 안함
      confirmed_assignees: [],
      comment_count: 0, // 답변 없음
      comments: [],
      follow_ups: [],
    ...
    },
    {
      ...
      content: "프로필 이미지 업로드 시 허용 용량과 확장자 제한이 어떻게 되는지 문의드립니다.\n\n현재 5MB 이상의 이미지가 업로드되지 않는 상황입니다.",
      inquiry_state: "RESOLVED",
      ...
      can_notify: false,
      is_scrapped: false,
      confirmed_assignees_count: 1, // 유일한 담당자 확인
      confirmed_assignees: [
        {
          user_id: 2,
          name: "이윤영",
      ...
      comment_count: 1, // 답변 1개 → 답변 완료 상태
      comments: [
        {
          comment_id: 7001,
          writer: {
